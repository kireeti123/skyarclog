...
class LogManager:
    ...
    def _emit_log(self, level: str, message: str, context: Optional[Dict] = None):
        """Emit a secure log entry to all listeners."""
